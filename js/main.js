...
const
    partList = {
        ...
        RAM: {
            ...
            descr: 'Оперативная память (ОЗУ) служит для временного хранения обрабатываемых компютером данных. Отличается гораздо более высокой скоростью чтения и записи чем у постоянной памяти.',
